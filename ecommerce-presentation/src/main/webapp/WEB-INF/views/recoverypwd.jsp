<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <html>
<head>
<title>Flower Shop - Recupero password</title>
...
<div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" /></span>Recupero password</div>
      <div class="feat_prod_box_details">
        <p class="details"> Inserisci i tuoi dati per poter recuperare la password</p>
        <div class="contact_form">
          <div class="form_subtitle">Recupero password</div>
          <form name="recoverypass" action = "pwdchange" method = "post">
            <div class="form_row">
            ...
            <div class="form_row">
              <label class="contact"><strong>Nuova Pass:</strong></label>
              <input type = "password" class="contact_input"  name = "new_pass" value = "" required/>
              <c:if test = "${new_pass == null }"></c:if>
            </div>
            <div class="form_row">
              <input type="submit" class="register" value="Resetta" />
            </div>
          </form>
        </div>
      </div>
