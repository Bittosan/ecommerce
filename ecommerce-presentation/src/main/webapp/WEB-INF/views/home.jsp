...
<div id="wrap">
  ...
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="resources/images/bullet1.gif" alt="" /></span>Prossimi arrivi</div>
      <div class="feat_prod_box">
        <div class="prod_img"><img src="resources/images/prod1.gif" alt="" border="0" /></div>
        <div class="prod_det_box">
          <div class="box_top"></div>
          <div class="box_center">
            <div class="prod_title">Bouquet giallo</div>
            <p class="details"> Amatissime, le rose sono senza dubbio la scelta più romantica e classica per un perfetto bouquet. Dal fascino e l'eleganza impareggiabile, sono il simbolo dell'amore.</p>
            <div class="clear"></div>
          </div>
      ...
      <div class="feat_prod_box">
        <div class="prod_img"><img src="resources/images/prod2.gif" alt="" border="0" /></div>
        <div class="prod_det_box">
          <div class="box_top"></div>
          <div class="box_center">
            <div class="prod_title">Bouquet viola</div>
            <p class="details">Romantiche e poetiche, le ortensie associano a un aspetto dolce e femminile un significato profondo e intrinsecamente legato all'amore, anche se varia da colore a colore.</p>
            <div class="clear"></div>
          </div>
          <div class="box_bottom"></div>
        </div>
        ...
        <div class="feat_prod_box">
        <div class="prod_img"><img src="resources/images/tulipanirosa.jpg" alt="" border="0" /></div>
        <div class="prod_det_box">
          <div class="box_top"></div>
          <div class="box_center">
            <div class="prod_title">Bouquet rosa</div>
            <p class="details">Simpatici, briosi e pieni di colore, i tulipani hanno un significato particolare, simboleggiando potere e ricchezza. Possono però essere considerati un buon auspicio per le coppie che vanno all'altare.</p>
            <div class="clear"></div>
          </div>
          <div class="box_bottom"></div>
        </div>
