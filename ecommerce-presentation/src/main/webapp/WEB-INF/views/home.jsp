				...
				<c:when test ="${email==null}">
					<br>
						<form action = "login" method = "post">
							<table>
								<tr><td><font color= black>Email</font></td><td> <font color= black>Password</font></td></tr>
								<tr><td><input type = "TEXT" name = "email" value = "" size = "13" required></td>
								<td><input type = "PASSWORD" name = "password" value = "" size = "13" required></td>
								<td><input type = "SUBMIT" name = accedi value = "accedi"></tr>				
							</table>
						</form>
