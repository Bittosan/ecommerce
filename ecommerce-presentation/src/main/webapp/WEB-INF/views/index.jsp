...
<div id="wrap">
  ...
  <div class="center_content">
    ...
    <div class="right_content">
      ...
      <div class="email_box"> <span class="red">Email:</span>
      <input type="text" name="email" value="" size="13" required/>  

       </div>
      <div class="password_box"> <span class="red">Password: </span> <input type = "password" name = "password" value = "" size = "13" required/>
       </div>
       <div class="login_box">		
       				<span><input type = "submit" name = accedi value = "accedi"></span>
							</div>
       	<div class="reg_pass_box">		
       				<span><a href="registration" style = "text-decoration: none;">
							<font class"red">Non sono registrato</font><br></a></span>
						<span><a href = "recoverypwd" style = "text-decoration: none;" >
							<font class="red">Ho dimenticato la password</font></a></span>
							</div>
