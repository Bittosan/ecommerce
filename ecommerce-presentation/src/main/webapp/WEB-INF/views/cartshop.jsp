...
<html>
<head>
<title>Flower Shop - Carrello</title>
...
<ul>
  ...
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="resources/images/bullet1.gif" alt="" /></span>Il Mio carrello</div>
      <div class="feat_prod_box_details">
        <table class="cart_table">
          ...
          <tr>
            ...
            <td>
				...
				<input type = "Submit" class="remove" value = "X"><br>
        ...
        <c:if test="${not empty sessionScope.cart}">
        	<form action = "vieworder" method = "GET">
				<input type = "Submit" class="order" value = "Riepilogo">
			</form>	
			</c:if>
  </div>
      <div class="clear"></div>
