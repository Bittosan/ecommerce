...
<html>
<head>
<title>Flower Shop - Catalogo</title>
...
<div id="wrap">
  <div class="header">
    ...
    <div id="menu">
      <ul>
        <c:choose>
  <c:when test="${sessionScope.type == 'Fiori'}">
          <li><a href="home">Home</a></li>
        <li class="selected"><a href="productType?tipo=Fiori">Fiori</a></li>
        <li><a href="productType?tipo=Vasi">Vasi</a></li>
        <li><a href="productType?tipo=Attrezzature">Attrezzature</a></li>
  </c:when>
  <c:when test="${sessionScope.type == 'Vasi'}">
          <li><a href="home">Home</a></li>
        <li><a href="productType?tipo=Fiori">Fiori</a></li>
        <li class="selected"><a href="productType?tipo=Vasi">Vasi</a></li>
        <li><a href="productType?tipo=Attrezzature">Attrezzature</a></li>  
  </c:when>
  <c:when test="${sessionScope.type == 'Attrezzature'}">
          <li><a href="home">Home</a></li>
        <li><a href="productType?tipo=Fiori">Fiori</a></li>
        <li><a href="productType?tipo=Vasi">Vasi</a></li>
        <li class="selected"><a href="productType?tipo=Attrezzature">Attrezzature</a></li>  
  </c:when>
  <c:otherwise>
          <li><a href="home">Home</a></li>
        <li><a href="productType?tipo=Fiori">Fiori</a></li>
        <li><a href="productType?tipo=Vasi">Vasi</a></li>
        <li><a href="productType?tipo=Attrezzature">Attrezzature</a></li>  </c:otherwise>
</c:choose>
  ...
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="resources/images/bullet1.gif" alt="" /></span>${sessionScope.type}</div>
      <div class="new_products">
      
      				<c:forEach items ="${sessionScope.list}" var = "product">
      
      	      <div class="new_prod_box"><span class="red">${product.description}</span> 
          <div class="new_prod_bg"> <a href="viewdetails?id_product=${product.id_product}"><img src="${product.image}" alt="" class="resizeimg" border="0" /></a> </div>
        </div>
